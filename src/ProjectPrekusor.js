...
export default function ProjectPrekusor() {
  return (
    <div className='project'>
      ...
      <p>
        Description: This PWA was made to showcase the images and video of a
        collective of artists operating in Seoul, Korea. Design brief: to use
        design to complement the artists' work; to create a 'tag' system that
        would allow users to navigate the work by topic; to be able to create
        pages with a simple JSON file; to randomize order of contents.
      </p>
